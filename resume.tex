...
\textbf{Backend Developer}, \textit{Commotion} (acq. by Tata Communications) (\href{https://gocommotion.com}{gocommotion.com})  \hfill July 2025 - Present
\begin{itemize}
        \itemsep -6pt {}
        \item Promoted from Backend Developer Intern (January 2025 - June 2025) 
    \item Developed scalable microservices to deliver \textbf{MCP tools} for \textbf{real-time voice AI agent} and data synchronization using \textbf{NestJS} and \textbf{FastAPI} focusing on \textbf{low latency} and \textbf{high performance}. Built web UI in \textbf{React} to visualize data collection.
            \item Integrated multiple \textbf{SaaS apps} and partnered with \textbf{enterprise clients} to deliver agentic AI integrations for better CX.
\end{itemize}
    ...
    \textbf{Information Technology Intern}, \textit{Kraymera} (\href{https://kraymera.com}{kraymera.com})  \hfill June 2023 - September 2023
...
\vspace{-1.25em}
\item \textbf{The Linux Foundation - LFX - Linux Kernel Mentorship Program mentee, Spring 2026} (\href{https://mentorship.lfx.linuxfoundation.org/project/53378ec5-48d7-4c49-a01f-8cbd3948db3d}{link}) \hfill {March 2026 - Present}
\begin{itemize}
\setlength\itemsep{-0.6em}
    \item Contributed to Linux kernel with \textbf{6 patches} accepted \href{https://lore.kernel.org/all/?q=ninadnaik07@gmail.com}{upstream}; mentored by \textbf{Shuah Khan}.
...
\begin{rSection}{SKILLS}
    ...
    \begin{tabular}{ l @{\hspace{6ex}} l }
        ...
        \textbf{Frameworks}: Flask, Node.js, Express.js, NestJS, MCP, Kafka & \textbf{Databases}: MySQL, PostgreSQL, MongoDB,  Redis       \\
        \textbf{API}: REST, GraphQL, gRPC                                & \textbf{Platforms \& Tools}: Linux, Docker, Git, AWS \end{tabular}
\end{rSection}
