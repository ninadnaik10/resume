...
\begin{rSection}{ROLES OF RESPONSIBILITY}
    ...
    % \begin{itemize}
    %     \item Contributed to the front-facing kitchen website of SimPPL displaying information about ongoing research in the organisation. Built a dynamic UI for displaying the research information pages with Next.js and Material UI.
    % \end{itemize}
