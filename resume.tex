...
\begin{itemize}
    ...
    \item Developed scalable microservices to deliver \textbf{MCP tools} for \textbf{real-time voice AI agent} and data synchronization using \textbf{NestJS} and \textbf{FastAPI} focusing on \textbf{low latency} and \textbf{high performance}. Built web UI in \textbf{React} to visualize collected data.
...
\vspace{-1.25em}
\item \textbf{The Linux Foundation - LFX - Linux Kernel Mentorship Program (LKMP), Spring 2026} (\href{https://mentorship.lfx.linuxfoundation.org/project/53378ec5-48d7-4c49-a01f-8cbd3948db3d}{link}) \hfill {March 2026 - Present}
\begin{itemize}
\setlength\itemsep{-0.6em}
    \item Contributed to Linux kernel Documentation subsystem with \textbf{2 patches} accepted \href{https://lore.kernel.org/all/?q=ninadnaik07@gmail.com}{upstream}; mentored by \textbf{Shuah Khan}.
    \item Worked with kernel development workflow, patch submission, and review cycles.
    \item Exploring \textbf{LED} and \textbf{hwmon} subsystems and using tools like \textbf{cscope}, \textbf{Coccinelle}, \textbf{smatch}, and \textbf{syzbot} for static analysis and bug detection. Selected for the mentorship program from \textbf{693 applicants}.
\end{itemize}
...
\begin{rSection}{PROJECTS}
  ...
  \textbf{Shortomega}, \textit{React.js, Next.js, Node.js, NestJS, TypeScript, Redis, Docker} | (\href{https://shortomega.ninadnaik.me/} {Website}, \href{https://github.com/ninadnaik10/shortomega} {GitHub})  \hfill {November 2024}
    \begin{itemize}
        ...
        \item Implemented \textbf{Dashboard, Analytics and Rate Limiting} features, and \textbf{Dockerized} the application for easy deployment.
    \end{itemize}
...
\begin{rSection}{SKILLS}
    ...
    \begin{tabular}{ l @{\hspace{6ex}} l }
        ...
        \textbf{Frameworks}: Flask, Next.js, Node.js, Express.js, NestJS, MCP & \textbf{Databases}: MySQL, PostgreSQL, MongoDB,  Redis       \\
