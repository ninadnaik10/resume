...
\begin{rSection}{WORK EXPERIENCE}
    ...
    \textbf{SDE Intern}, \textit{Commotion} (\href{https://gocommotion.com}{gocommotion.com})  \hfill January 2025 - Present

    \begin{itemize}
        \itemsep -6pt {}
        \item Responsible for developing the \textbf{back-end services} for the \textbf{integration platform} using \textbf{NestJS, GraphQL and React.js}.
    \end{itemize}
...
\begin{rSection}{PROJECTS}
    ...
    % \end{itemize}
 \item \textbf{Shortomega}, \textit{Next.js, NestJS, TypeScript, Redis, Docker} | (\href{https://shortomega.ninadnaik.xyz} {Website}, \href{https://github.com/ninadnaik10/shortomega} {GitHub})  \hfill {October 2024}
    \begin{itemize}
        \setlength\itemsep{-0.6em}
    ...
    \end{itemize}
    \item \textbf{CodeIt}, \textit{React.js, Firebase, Docker, Amazon Web Services} | (\href{https://codeitonline.xyz/}{Website}, \href{https://github.com/ninadnaik10/codeit}{GitHub}) \hfill {October 2023}
    \begin{itemize}
        \setlength\itemsep{-0.6em}
