...
\begin{rSection}{PROJECTS}
  ...
  \textbf{Shortomega}, \textit{Next.js, NestJS, TypeScript, Redis, Docker} | (\href{https://shortomega.vercel.app/} {Website}, \href{https://github.com/ninadnaik10/shortomega} {GitHub})  \hfill {October 2024}
    ...
    \begin{itemize}
        \setlength\itemsep{-0.6em}
        \item Created a specialized \textbf{full-stack online coding platform} with instructor tools for group management, coding challenges, submission oversight, and an integrated learner/instructor dashboard with code editor and analysis.
              % \item Played a key role in \textbf{constructing the database} and \textbf{integrating programming language compilers} on the AWS Cloud.
