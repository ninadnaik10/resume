...
\begin{rSection}{WORK EXPERIENCE}
    ...
    \begin{itemize}
        ...
        %       increase in customer acquisition.
              ...
              \item Configured \textbf{Zoho CRM system} with \textbf{automated WhatsApp Business API processes} using \textbf{Zoho Deluge scripting}, deploying \textbf{CentOS server} and configuring networking devices and GSM gateway to drive an increase in lead conversion and enhance customer acquisition strategies.
    \end{itemize}
\end{rSection}
    ...
    \begin{itemize}
        ...
        \item  Led a team in the creation of \textbf{an AI public speaking practice app}, with
              the focus on analyzing speech metrics---\textbf{filler words,
                  speech pace, and confidence levels}. \item Integrated features to save results, \textbf{analyze progress} and \textbf{provide comprehensive feedback}.
...
\begin{rSection}{Achievements \& Extracurricular Activity}
    \begin{itemize}
        ...
        \item Maintaining an \textbf{active tech blog} to share experiences, learnings and results on \href{https://tech.ninadnaik.me}{tech.ninadnaik.me}
